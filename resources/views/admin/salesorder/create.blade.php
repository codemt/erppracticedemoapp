...
<div ng-app="salesorderApp" ng-controller="SalesOrderController as soc" ng-clock >
    <?=Form::open(['method' => 'POST', 'route' => ['salesorder.store'], 'class' => 'm-0 form-horizontal','files'=>true])?>
        <input type="hidden" name="roleid" value="<?= $user_data['role_id']?>" id="roleid" ng-model='salesorder.role_id'>
        <input type="hidden" name="user_id" value="<?= $user_data['adminid']?>" id="user_id">
        <div class="row">
                            ...
                            <div class="row">  
                                <div class="col-md-4">
                                    <div class="form-group" id="company_id_error_div">
                                        ...
                                        <div class="col-md-12">
                                            <?= Form::select('company_id',$companies, old('company_id'),array('class' => 'form-control select2','id'=>'company_id','ng-model'=>'salesorder.company_id','ng-change'=>'companyChange()')) ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" id="customer_id_error_div">
                                        ...
                                        <div class="col-md-12">
                                            <select name="customer_id" ng-model="salesorder.customer_id" class='form-control select2' id="customer_id" ng-disabled="!(!!salesorder.company_id)">
                                                <option value="">Select Customer</option>
                                                <option ng-repeat="customer in soc.customers" value="{% customer.id %}">{% customer.name%}</option>
                                            </select>
                                ...
                                <div class="col-md-12 mb-10">    
                                    <div class="animated-checkbox">
                                        <label class="control-label">
                                            <input type="checkbox" value="1" class="form-control" name="check_billing" id="check_billing" ng-model="salesorder.check_billing">
        ...
        <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive nowrap" >
                                    ...
                                    <tbody>
                                        <tr ng-repeat="(k,cartProduct) in soc.cartProducts">
                                            ...
                                            <td><span ng-hide="cartProduct.unitediting" ng-click="soc.editUnitValue(cartProduct)">{% cartProduct.unit_value %}</span><input class="number_only" type="text" ng-show="cartProduct.unitediting" ng-model="cartProduct.unit_value" ng-blur="soc.doneChangeUnitValue(cartProduct)" autofocus style="width: 80px" /></td>
                        ...
                        <table class="table scrollable table-striped table-bordered table-condensed table-hover dt-responsive nowrap" id="multiple_order" style="max-height: 500px !important;overflow-y: auto;display: inline-block;width: 100%;">
                            ...
                            <tbody>
                                <tr ng-repeat="(k,product) in new_product | filter : product_search">
                                    ...
                                    <td class="col-md-3">
                                        <?= Form::text('unit_value',old('unit_value'),['id'=>'unit_value','class'=>'form-control input-sm number_only','ng-model' => 'product.unit_value','numbersOnly']) ?>
                                    </td>
            ...
            <script type="text/ng-template" id="salesorderview.html">
                <div class="modal-header">
                    <button type="button" class="close" ng-click="soc.modalCancel()">&times;</button>
                    <h3 class="modal-title" id="modal-title">Sales Order
                    </h3>
                </div>
                <div class="modal-body table-container" id="modal-body">
                            ...
                            <tr>
                                <td style="width: 48%;padding: 0">
                                    <table style="width: 100%;border: medium none;">
                                        ...
                                        <tr>
                                            <td colspan="2" style="border: medium none;">{%view_data.company_name%}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="border: medium none;">{%view_data.billing_address%}</td>
                                        </tr>
                                        <tr>
                                            <td style="border: medium none;">City: {%view_data.bill_city%}</td>
                                            <td style="border: medium none;">Pincode: {%view_data.bill_pincode%}</td>
                                        </tr>
                                        <tr>
                                            <td style="border: medium none;">State: {%view_data.bill_state%}</td>
                                            <td style="border: medium none;">Country: {%view_data.bill_country%}</td>
                                        </tr>
                                        <tr>
                                            <td width="100%" style="border: medium none;" colspan="2" valign="top"><span style="width: 30%;display: inline-block;vertical-align: top">Contact Details :</span><span style="width: 70%;display: inline-block;vertical-align: top">{%view_data.contact_name%}/{%view_data.contact_email%}/<br>{%view_data.contact_no%}</span></td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td style="width: 48%;padding: 0">
                                    <table style="width: 100%;border: medium none;">
                                        ...
                                        <tr>
                                            <td colspan="2" style="border: medium none;">{%view_data.shipping_address%}</td>
                                        </tr>
                                        <tr>
                                            <td style="border: medium none;">City: {%view_data.ship_city%}</td>
                                            <td style="border: medium none;">Pincode: {%view_data.pin_code%}</td>
                                        </tr>
                                        <tr>
                                            <td style="border: medium none;">State: {%view_data.ship_state%}</td>
                                            <td style="border: medium none;">Country: {%view_data.ship_country%}</td>
                                        </tr>
                                        <tr>
                                            <td width="100%" style="border: medium none;" colspan="2" valign="top"><span style="width: 30%;display: inline-block;vertical-align: top">Contact Details :</span><span style="width: 70%;display: inline-block;vertical-align: top"> {%view_data.contact_name%}/{%view_data.contact_email%}/<br>{%view_data.contact_no%}</span></td>
                                        </tr>
                    ...
                    <br style="clear: both">
                        <div style="display: inline-block;width: 100%;margin-bottom: 15px">
                            <table style="width: 100%;" class="so_view">
                                ...
                                <tr>
                                    <td>{%view_data.so_no%}</td>
                                    <td>{%view_data.payment_terms%}</td>
                                    <td>{%view_data.delivery%}</td>
                                    <td>{%view_data.trasport%}</td>
                                    <td>{%view_data.ship_city%}</td>
                                </tr>
                            </table>
                        </div>
                    <br style="clear: both">
                    ...
                    <div style="display: inline-block;width: 100%;margin-bottom: 15px">
                        <table style="width: 100%;border: medium none;" class="border-bottom so_view">
                            ...
                            <tbody ng-repeat="(item_key,item_value) in view_data.order_item_pdf">
                                <tr ng-repeat="(item_data_key,item_data_value) in item_value">
                                    <td style="border-bottom: medium none;"><strong>{%item_data_value.productname%}</strong></td>
                                    ...
                                    <td style="border-bottom: medium none;" align="right"><strong>{%item_data_value.quantity%} Nos</strong></td>
                            ...
                            <tr>
                                ...
                                <td><br></td>
                                <td><br></td>
                                <td style="border-top:1px solid #333;" align="right">{%view_data.total_amount%}</td>
                            </tr>
                            <tr>
                                <td><br></td>
                                ...
                                <td><br></td>
                                <td><br></td>
                                <td align="right">{%view_data.fright%}</td>
                            </tr>
                            <tr>
                                <td><br></td>
                                ...
                                <td><br></td>
                                <td><br></td>
                                <td align="right">{%view_data.pkg_fwd%}</td>
                            </tr>
                            <tr ng-if="(view_data.igst == true)">
                                <td><br></td>
                                ...
                                <td><br></td>
                                <td><br></td>
                                <td align="right"><strong>{%(view_data.tax_subtotal) + (view_data.total_tax_amount)%}</strong></td>
                            </tr> 
                            <tr ng-if="(view_data.igst == false)">
                                <td><br></td>
                                ...
                                {%((view_data.tax_subtotal + view_data.total_tax_amount)/2) | number:2 %}</strong></td>
                            </tr>
                            <tr ng-if="(view_data.igst == false)">
                                <td><br></td>
                                ...
                                <td><br></td>
                                <td><br></td>
                                <td align="right"><strong>{%((view_data.tax_subtotal) + (view_data.total_tax_amount)/2)%}</strong></td>
                            </tr>
                            <tr>
                                <td><br></td>
                                <td>Round Off</td>
                                ...
                                <td><br></td>
                                <td><br></td>
                                <td align="right"><strong>{% view_data.round_off%}</strong></td>
                            </tr>
                            <tr>
                                <td><br></td>
                                ...
                                <td><br></td>
                                <td><br></td>
                                <td><strong>{%view_data.total_qty%} Nos</strong></td>
                                <td><br></td>
                                <td><br></td>
                                <td align="right"><strong>{%view_data.grandTotal%}</strong></td>
                    ...
                    <div style="display: inline-block;width: 100%;margin-bottom: 30px">
                        <table class="border-none so_view" style="width: 100%">
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong>INR {%view_data.total_in_word%} Rupees</strong>
                                </td>
                            </tr>
                        </table>
                    </div> 
                    <div style="display: inline-block;width: 100%;" class="table-responsive">
                        <table style="width: 100%" class="so_view">
                            <tr>
                                ...
                                <td colspan="2" ng-if="(view_data.igst == true)" width="20%">Integrated Tax</td>
                                <td colspan="2" ng-if="(view_data.igst == false)" width="10%">Central Tax</td>
                                <td colspan="2" ng-if="(view_data.igst == false)" width="10%">State Tax</td>
                                <td width="10%">Total</td>
                            </tr>
                            <tr>
                                <td></td>
                                <td >value</td>
                                <td ng-if="(view_data.igst == true)">Rate</td>
                                <td ng-if="(view_data.igst == true)">Amount</td>
                                <td ng-if="(view_data.igst == false)">Rate</td>
                                <td ng-if="(view_data.igst == false)">Amount</td>
                                <td ng-if="(view_data.igst == false)">Rate</td>
                                <td ng-if="(view_data.igst == false)">Amount</td>
                                <td>Tax Amount</td>
                            </tr>
                            <tbody ng-repeat="(key,value) in view_data.hsn_codes">
                                <tr ng-if="(view_data.igst == true)" class="hsn_tr">
                                ...
                                <tr ng-if="(view_data.igst == false)" class="hsn_tr">
                                    <td>{%value.hsn_code%}</td>
                                    <td>{%value.total_hsn_value%}</td>
                                    <td>9%</td>
                            ...
                            <tr style="border-top:medium none;" ng-if="(view_data.igst == true)">
                                <td>996511</td>
                                <td>{% view_data.fright_pkg_fwd_hsn %}</td>
                                <td>18%</td>
                                <td>{% view_data.igst_fright_hsn %}</td>
                                <td>{% view_data.igst_fright_hsn %}</td>
                            </tr> 
                            <tr style="border-top:medium none;" ng-if="(view_data.igst == false)">
                                <td>996511</td>
                                <td>{%view_data.fright_pkg_fwd_hsn%}</td>
                                <td>9%</td>
                                <td>{% view_data.cgst_sgst_fright_hsn %}</td>
                                <td>9%</td>
                                <td>{% view_data.cgst_sgst_fright_hsn %}</td>
                                <td>{% view_data.igst_fright_hsn %}</td>
                            </tr>
                            </tr>    
                            <tr ng-if="(view_data.igst == true)" class="igst_tr">
                                <td>Total</td>
                                <td>{%view_data.total_taxable_value%}</td>
                                <td></td>
                                <td>{%view_data.igst_total%}</td>
                                <td>{%view_data.hsn_grand_total %}</td>
                            </tr>
                            <tr ng-if="(view_data.igst == false)" class="igst_tr">
                                <td>Total</td>
                                <td>{%view_data.total_taxable_value%}</td>
                                <td>9%</td>
                                <td>{%view_data.cgst_sgst_total | number:2%}</td>
                                <td></td>
                                <td>{%view_data.cgst_sgst_total | number:2%}</td>
                                <td>{%view_data.hsn_grand_total %}</td>
                            </tr> 
                            <tr>
                                <td height="auto">
                                    Company's PAN: <strong>{%view_data.pan_no%}</strong>
                                    <br>
                                    GST No:<strong>{%view_data.gst_no%}</strong>
                                </td>
                                <td rowspan="3" colspan="4" align="right" ng-if="(view_data.igst == true)">
                                    <br>
                                    <br>
                                    <br>
                                    <br>
                                ...
                                <td rowspan="3" colspan="6" align="right" ng-if="(view_data.igst == false)">
                                    <br>
                                    <br>
                                    <br>
                                    <br>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <?= Form::text('other_expense', old('other_expense'),array('class' => 'form-control select2 number_only','id'=>'other_expense','placeholder'=>'Other Expense','ng-model'=>'salesorder.other_expense')) ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('grand_total')) has-error @endif">
                                    ...
                                    <div class="col-md-12">
                                        <?= Form::text('grand_total', old('grand_total'),array('class' => 'form-control','placeholder'=>'Grand Total','ng-init'=>'salesorder.grand_total=0','ng-model'=>'salesorder.grand_total','readonly'=>true)) ?>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var getcustomerurl = "<?= URL::route('admin.salesorder.getcustomer')?>";
        var removeproducturl = "";
        var getsupplierproducturl = "<?= URL::route('salesorder.getSupplierProducts')?>";
        var redirect_url = "<?= URL::route('salesorder.index')?>";
        ...
        //     $.ajax({
        //     async      : false,
        //     url        : '{{ URL::route('admin.salesorder.getcustomer')}}',
        //     type       : 'post',
        //     data       : { "company_id": val , '_token' : token },
        //     dataType   : 'html',
        //     success    : function(customers) {
        //             $("#customer_id").val('').trigger('change');
        //             var customer_options = $(customers).html();
        //             $("#customer_id").html(customer_options);
        //         }
        //     });
        // }
        $(document).ready(function(){
