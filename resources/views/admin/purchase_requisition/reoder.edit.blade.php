...
@section('start_form')
    <?=Form::model($purchase_requisition_data,['method' => 'POST', 'route'=>['purchase-requisition.store',$id], 'class' => 'm-0 form-horizontal'])?>
@stop
...
<nav class="navbar navbar-static-top">
    ...
    <div class="pl-10">
        <button type="submit" id="re_order" name="re_order" value="re_order" class="btn btn-primary btn-sm disabled-btn" title="Save and add new"> Reorder  </button>
        <button type="submit" name="save_new" value="save_new" class="btn btn-primary btn-sm disabled-btn" title="Save and add new">Re Order  </button>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group @if($errors->has('company_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::select('company_id',$company_list, old('company_id',$purchase_requisition_data['company_id']),array('class' => 'form-control select_2 select company','placeholder'=>'Select Company','id'=>'company_name')) ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('supplier_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::select('supplier_id',$supplier_list, old('supplier_id',$purchase_requisition_data['supplier_id']),array('class' => 'form-control select_2 select supplier','placeholder'=>'Select Manufacturer','id' => 'supplier')) ?>
...
<div class="text-right">
        <button type="submit" name="re_order" value="re_order" class="btn btn-primary btn-sm disabled-btn" title="Save and add new"> Reorder </button>
