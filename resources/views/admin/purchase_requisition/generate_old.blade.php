                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('company_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::text('company_id', $company_name,array('class' => 'form-control select_2 select company','placeholder'=>'type name','id'=>'company')) ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('supplier_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::text('supplier_id', $supplier_name,array('class' => 'form-control select_2 select supplier','placeholder'=>'type name','id' => 'supplier')) ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('distributor_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::text('distributor_id','',array('class' => 'form-control select_2 select distributor','placeholder'=>'type name','id' => 'distributor')) ?>
                                    ...
                                    @foreach($product_array_data as $key=>$value)
                                        <tr id="shipping" class="row">
                                            <td valign="top" class="col-md-3" style="border:none;padding-left: 0;">
                                                <?= Form::text('model_no[]',$value[0]['model_no'], ['class' => 'form-control select2 model_no','id'=>'model_no','style'=>'width:247px']); ?><br>
                                            ...
                                            <td valign="top"  class="col-md-3" style="border:none;">
                                                <?= Form::text('product_name[]',$value[0]['name_description'],['class' => 'form-control product_name','id'=>'product_name','style'=>'width:247px','readonly'=>'readonly']); ?>
                                            ...
                                            <td valign="top" class="col-md-3" style="border:none;">
                                                ...
                                                @else
                                                     <?= Form::number('qty[]',$value[0]['po_qty'], ['class' => 'form-control','id'=>'qty','style'=>'width:247px','min'=>1]); ?>
                                                @endif
