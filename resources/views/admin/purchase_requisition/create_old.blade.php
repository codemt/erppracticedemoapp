                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('company_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::select('company_id',$company_list, old('company_id'),array('class' => 'form-control select_2 select company','placeholder'=>'type name','id'=>'company')) ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('supplier_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::select('supplier_id',$supplier_list, old('supplier_id'),array('class' => 'form-control select_2 select supplier','placeholder'=>'type name','id' => 'supplier')) ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('distributor_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::select('distributor_id',$distributor_list, old('distributor_id'),array('class' => 'form-control select_2 select distributor','placeholder'=>'type name','id' => 'distributor')) ?>
                                ...
                                <tbody>
                                    <tr id="shipping" class="row">
                                        <td valign="top" class="col-md-3" style="border:none;padding-left: 0;">
                                            ...
                                            <strong><small class="form-text text-muted">Company name , Supplier name must required for model no.</small></strong><br>
...
*/
        ...
        function model_ajax(token,supplier_value,company_value,url,model_array){
            ...
            $('.company').change(function(){
                $('.model_no').val(model_old).trigger('change');
            });
