                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group @if($errors->has('company_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::select('company_id',$company_list, old('company_id',$purchase_requisition_data['company_id']),array('class' => 'form-control select_2 select company','placeholder'=>'type name')) ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('supplier_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::select('supplier_id',$supplier_list, old('supplier_id',$purchase_requisition_data['supplier_id']),array('class' => 'form-control select_2 select supplier','placeholder'=>'type name','id' => 'supplier')) ?>
