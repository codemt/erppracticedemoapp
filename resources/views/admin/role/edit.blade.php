...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card">
          ...
          <!--   <?php echo $role ?> -->
            <?=Form::model($role, ['method' => 'PATCH', 'route' => ['role.update', $role['id']], 'role' => 'form'])?>
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-6">
		...
		<div class="text-right">
            <button type="submit" name="save_button" value="save_new" class="btn btn-primary btn-sm disabled-btn" title="Save & Add New user">Update</button>
