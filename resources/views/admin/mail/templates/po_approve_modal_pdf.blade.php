...
<body>
	...
	<div style="display: inline-block;width: 100%;margin-bottom: 15px">
		<table style="width: 100%;border: medium none;">
			<tr>
				<td style="width: 48%;float: left;padding: 0">
					<table style="width: 100%;border: medium none;">
						<tr>
				...
				<td style="width: 48%;float: right;padding: 0;">
					<table style="width: 100%;border: medium none;">
						<tr>
			...
			@foreach($get_model_details as $item_key=>$item_value)
				<tr>
					...
					@else
						...
						<td align="right"> Nos</td>
						<td align="right"><strong>{{str_replace(',','',$item_value[0]['dollar_price']) * $item_value[0]['qty']}}</strong></td>
					@endif
				</tr>
			@endforeach
			<tr>
