			...
			<tr>
				<td style="border: medium none;width: 48%;padding: 0;display: inline-block;">
					<table style="border: medium none;width: 100%;">
						<tr>
							<td style="border: medium none;width: 30%;padding-left:0 "><strong>PO No is :</strong></td>
				...
				<td style="width: 48%;padding: 0;display: inline-block;">
					<table style="width: 100%;border:medium none">
						<tr>
		...
		<table style="width: 100%;border: medium none;">
			<tr>
				<td style="width: 48%;float: left;">
					<table style="width: 100%;border: medium none;">
						<tr>
							<td colspan="2" style="border: medium none;"><strong style="font-size:16px">Bill To</strong></td>
						</tr>
						<tr>
				...
				<td style="width: 48%;float: right">
					<table style="width: 100%;border: medium none;">
						<tr>
							<td colspan="2" style="border: medium none;"><strong style="font-size:16px">Ship To</strong></td>
						</tr>
						<tr>
							<td colspan="2" style="border: medium none;">{{$invoice_company_details['company_name']}}</td>
						</tr>
		...
		<table style="width: 100%;" class="border-bottom">
			...
			@foreach($get_model_details as $item_key=>$item_value)
				<tr>
					...
					@if(isset($purchase_data['distributor_id']))
					<td>{{$distributor_details['distributor_name']}}</td>
					@endif
					...
					@else
						...
						<td align="right"> Nos</td>
						<td align="right"><strong>{{$item_value[0]['dollar_price'] * $item_value[0]['qty']}}</strong></td>
					@endif
				</tr>
			@endforeach
			<tr>
