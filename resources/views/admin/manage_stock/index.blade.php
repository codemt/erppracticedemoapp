                ...
                <table id="managestock_table" class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Open So Qty</th>
                            <th>Open PO Qty</th>
                            @if(App\Helpers\DesignationPermissionCheck::isPermitted('manage_stock.release'))
                            <th> Release </th>       
                            @endif
                        </tr>
                    </thead>
...
$(function(){
    ...
    master = $('#managestock_table').dataTable({
        ...
        { mData:"blocked_by",bSortable : true,bVisible:true,sClass : 'text-center',sWidth:"16%",
        mRender: function(v,t,o){
                    ...
                    if(v != null)
                        var act_html = '<span class="badge badge-success">'+v+'</span>';
         ...
         @if(App\Helpers\DesignationPermissionCheck::isPermitted('manage_stock.release'))
        {
                    ...
                    mRender: function(v, t, o) {
                        ...
                        var is_check = "<?= App\Helpers\DesignationPermissionCheck::isPermitted('manage_stock.release') ?>";
                        if(is_check != 0)
                        { 
