...
<nav class="navbar navbar-static-top">
    <div class="title">
        <h4><i class="fa fa-list"></i>Purchase Requisition Approval</h4>
    </div>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    $('#purchase_requisition_table').DataTable({
        ...
        "sAjaxSource": '<?= route('purchase-requisition-approval.index')?>',
        ...
        "aoColumns": [
            ...
            { mData:"company_name",bSortable : true,sClass : 'text-center',sWidth:"10%",
                ...
                // if(o['purchase_approval_status'] == 'pending'){
                //   var act_html  = '<a title="Edit '+o['company_id']+'" href="'+edit_path+'">'+ v +'</a>'
                // }
                // else{
                //   var act_html  =  v 
                // }
