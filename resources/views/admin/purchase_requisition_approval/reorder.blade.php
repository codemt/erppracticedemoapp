...
<nav class="navbar navbar-static-top">
    <div class="title">
        <h4><i class="fa fa-list"></i> Re Order Purchase Requisition Approval</h4>
    </div>
    ...
    <div class="pl-10">
      ...
      <a href="{{ url('admin/purchase-requisition-approval/index') }}" class="btn btn-primary btn-sm disabled-btn"> Back </a>
      <button type="button" id="addNew" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"> Restore </button>
    </div>
</nav>
@stop
@section('content')
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content">
            ...
            <h4 class="modal-title" id="title" class="title"> Restore Deleted Orders </h4>
            </div>
            <div class="modal-body">
            <input type="text" name="addItem" id="poId" placeholder="Enter PO No">
            </div>
            <div class="modal-footer">
            <a  class="btn btn-default" data-dismiss="modal" id="restore" name="restore"> Restore Link</a>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    $('#restore').click(function(e){
            ...
            e.preventDefault();
            console.log(e);
           var restoreId =  $('#poId').val();
           console.log("Restore ID is" +restoreId);
           ...
           $.ajaxSetup({
            ...
            $.ajax({
               url: "{{ url('/admin/purchase-requisition-approval/restore') }}",
               type: 'post',
               datatype: 'JSON',
                data: {'id': restoreId },
               success: function(result){
                   ...
                   console.log(final);
                 toastr.success('Record Restored.');
    ...
    $('#purchase_requisition_table').DataTable({
        ...
        "sAjaxSource": '<?= route('admin.reorder')?>',
        ...
        "aoColumns": [
            ...
            // { mData:"created_at",bSortable : true,sClass : 'text-center',sWidth:"5%",bVisible:false },
            { mData:"company_name",bSortable : true,sClass : 'text-center',sWidth:"10%",
                 mRender : function(v,t,o){  
                   ...
                   if(is_check != 0){
                      var edit_path = "<?= route('purchase.get',['id'=>':id']) ?>";
            ...
            { mData:"total_price",bSortable : true,sClass : 'text-center',sWidth:"10%" },
            { mData:"dollar_total_price",bSortable : true,sClass : 'text-center',sWidth:"15%" },
            { mData:"purchase_approval_status",bSortable : true,sClass : 'text-center',sWidth:"20%",
                mRender: function(v,t,o){
                    if (v == "<?= config('Constant.status.approve')?>") {
                        ...
                        var act_html = '<span class="badge badge-danger"><?= ucwords(config('Constant.status.deleted'))?></span>';
