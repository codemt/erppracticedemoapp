...
<nav class="navbar navbar-static-top">
    ...
    <div class="pl-10">
      ...
      <a href="{{ url('admin/purchase-requisition-approval/reorder') }}" class="btn btn-primary btn-sm disabled-btn"> Back </a>
    </div>
</nav>
@stop
@section('content')
        ...
        "aoColumns": [
            ...
            { mData:"company_name",bSortable : true,sClass : 'text-center',sWidth:"10%",
                 mRender : function(v,t,o){  
                   ...
                   if(is_check != 0){
                      var edit_path = "<?= route('purchase-requisition-approval.edit',['id'=>':id']) ?>";
