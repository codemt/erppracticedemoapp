                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('supplier_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::select('supplier_id',$supplier_list, old('supplier_id'),array('class' => 'form-control select_2 supplier','placeholder'=>'type name','id' => 'supplier')) ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group @if($errors->has('combo_product')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::select('combo_product[]',$product_list, old('combo_product[]'),array('class' => 'form-control select2 combo_product','id'=>'multi_select','multiple'=>true)) ?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            @if(old('combo_product'))
                var combo_product = {!! json_encode(old('combo_product')) !!};
