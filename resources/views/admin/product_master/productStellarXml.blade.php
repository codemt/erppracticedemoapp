   ...
   @foreach($all_suppliers as $supplier_data)
    <TALLYMESSAGE xmlns:UDF="TallyUDF">
     <STOCKGROUP NAME="{{$supplier_data['supplier_name']}}" RESERVEDNAME="">
      <GUID>b46bc1ff-4e17-4958-adfa-6b8b0b8dde8e-00000b26</GUID>
      <PARENT/>
  ...
  @foreach($all_products_data as $data)
    <TALLYMESSAGE xmlns:UDF="TallyUDF">
     <STOCKITEM NAME="{{$data['model_no']}}" RESERVEDNAME="">
      ...
      <GUID>b46bc1ff-4e17-4958-adfa-6b8b0b8dde8e-00000c24</GUID>
      ...
      <EXCISETARIFFDETAILS.LIST>
       <APPLICABLEFROM>20150401</APPLICABLEFROM>
       <TYPEOFTARIFF>Dutiable</TYPEOFTARIFF>
       <REPORTINGUOM>U</REPORTINGUOM>
       <TARIFFNAME>{{$data['model_no']}}</TARIFFNAME>
       <HSNCODE>73089090</HSNCODE>
       <VALUATIONTYPE>Ad Valorem</VALUATIONTYPE>
       <ISEXCISECALCULATEONMRP>No</ISEXCISECALCULATEONMRP>
      ...
      <BATCHALLOCATIONS.LIST>
       <GODOWNNAME>{{$company_name['company_name']}}</GODOWNNAME>
      ...
      <EXCISEITEMGODOWN.LIST>
       <EXCISEALLOCTYPE>Default</EXCISEALLOCTYPE>
       <TAXUNITNAME>{{$company_name['company_name']}}</TAXUNITNAME>
       <STOCKITEMTYPE>Finished Goods</STOCKITEMTYPE>
       <EXCISEREPUNITSSTR>U</EXCISEREPUNITSSTR>
       <EXCISECONVUNIT>Nos.</EXCISECONVUNIT>
       <EXCISEALTREPUNITS> 1</EXCISEALTREPUNITS>
       <EXCISEREPDENOMINATOR> 1</EXCISEREPDENOMINATOR>
       <EXCISEBOM.LIST>       </EXCISEBOM.LIST>
       <EXCISEDUTIES.LIST>       </EXCISEDUTIES.LIST>
       <EXCISEMRPRATES.LIST>       </EXCISEMRPRATES.LIST>
      </EXCISEITEMGODOWN.LIST>
      <EXCISEITEMGODOWN.LIST>
       <EXCISEALLOCTYPE>Default</EXCISEALLOCTYPE>
       <TAXUNITNAME>{{$company_name['company_name']}}</TAXUNITNAME>
