                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('supplier_id')) has-error @endif">
                                ...
                                <div class="col-md-12">
                                    <?= Form::select('supplier_id',$supplier_list, old('supplier_id'),array('class' => 'form-control select_2 supplier','id'=>'edit_supplier','placeholder'=>'Select Manufacturer')) ?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            @if(old('company_id',$copany_id_array))
                ...
                $.each(company_id,function(k,v){
                    $(".company").append($('<option>', {value: v, text: v}));
                })
            @endif
