...
@stop
@section('start_form')
    <?=Form::open(['class' => 'm-0 form-horizontal','files'=>true,'id'=>'user_create_form'])?>
@stop
...
<nav class="navbar navbar-static-top">
    ...
    <div class="pl-10">
        <button type="submit" name="save_button" value="save_new" id="save_new_1" class="btn btn-primary btn-sm disabled-btn save" title="Save and add new">Save & New</button>
        <button type="submit" name="save_button" value="save_exit" id="save_exit_1" class="btn btn-primary btn-sm disabled-btn save and exit" title="Save ">Save & Exit</button>
        <a href="<?=URL::route('systemuser.index')?>" class="btn btn-default btn-sm" title="Back to users Page">Cancel</a>
    </div>
</nav>
@stop
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <?= Form::select('designation_id',$designation_list,old('designation_id'),array('class' => 'form-control designation designation','placeholder'=>'Select Designation','id'=>'designation')) ?>
                                    ...
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        ...
                                        <div>
                                            <label class="btn btn-file">
                                                <?=Form::file('image', ['class' => 'form-control','id'=>'image_div'])?>
...
<div class="text-right">
    <button type="submit" name="save_button" value="save_new" id="save_new_2" class="btn btn-primary btn-sm disabled-btn save" title="Save & Add New user">Save & New</button>
    <button type="submit" name="save_button" value="save_exit" id="save_exit_2" class="btn btn-primary btn-sm disabled-btn save" title="Save and exit">Save & Exit</button>
    <a href="<?=URL::route('systemuser.index')?>" class="btn btn-default btn-sm" title="Back to user Page">Cancel</a>
</div>
@stop
...
<script type="text/javascript">
    ...
    function loadDesignation(val)
    {
        ...
        $.ajax({
            ...
            success    : function(get_designationIn) {
                ...
                $('.designation').html('');
                $("#designation").html(designation_options);
            }
        });
    }
    ...
    $(document).ready(function() {
        ...
        $(".save").click(function(e){
            e.preventDefault();
            var val = $(this).val();
            var url = "<?= URL::route('systemuser.store') ?>";
                ...
                {             
                    ...
                    if (resp.success == true) {
                        ...
                        if(val == 'save_new')
                        {
                            ...
                            window.location.href = "<?=route('systemuser.create')?>";
                        }
                        else
                        {
