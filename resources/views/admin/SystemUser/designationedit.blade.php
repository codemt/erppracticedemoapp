...
@section('start_form')
    <?=Form::model($designation, ['method' => 'PATCH', 'route' => ['designation.update', $designation['id']], 'designation' => 'form'])?>             
@stop
...
<nav class="navbar navbar-static-top">
    ...
    <div class="pl-10">
        ...
        <a href="<?= route('designation.index') ?>" class="btn btn-default btn-sm" title="Back to users Page">Cancel</a>
    </div>
</nav>
@stop
@section('content')
    ...
    <div class="col-md-12 mb-30">
        <div class="card">
            <div class="card-title-w-btn">
                <h4 class="title">Edit Designation Master</h4>
            </div><hr>
            <div class="row"> 
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">                         
                            <div class="form-group @if($errors->has('name')) {{ 'has-error' }} @endif row"> 
                                <div class="control-label col-md-12">Designation Name<sup class="text-danger">*</sup></div> 
                                <div class="col-md-12">                          
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('description')) {{ 'has-error' }} @endif row">
                                <div class="control-label col-md-12">Description<sup class="text-danger">*</sup></div>
                                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="row"> 
                        <div class="col-md-6">                         
                            <div class="form-group @if($errors->has('team_id')) {{ 'has-error' }} @endif row"> 
                                <div class="control-label col-md-12">Team<sup class="text-danger">*</sup></div> 
                                <div class="col-md-12">                          
                        ...
                        <div class="col-md-6">                         
                            <div class="form-group row @if($errors->has('status')) {{ 'has-error' }} @endif">
                                <div class="control-label col-md-12">Status</div>
                                <div class="col-md-12">
