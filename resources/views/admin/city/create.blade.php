...
@stop
@section('start_form')
        <?= Form::open(['url'=>route('cities.store'),'id'=>'login_form','class'=>'login-form', 'method' => 'POST']) ?> 
@stop
                ...
                <div class="col-md-12"> 
                    <div class="col-md-6">  
                        <div class="form-group @if($errors->has('state')) 'has-error' @endif">
                            ...
                            <?=Form::select('state', ['' => 'Select state'] + $state, null, ['class' => 'form-control full', 'data-width' => '100%', 'id' => 'state']);?> 
                    ...
                    <div class="col-md-6">  
                        <div class="form-group @if($errors->has('title')) 'has-error' @endif">
                            ...
                            <?=Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'Enter title Name']);?>
