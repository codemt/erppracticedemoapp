...
use App\Jobs\PurchaseRequisitionValidateJob;

class PurchaseRequisitionValidateListener
{
    /**
    ...
    public function handle(PurchaseRequisitionEvent $event)
    {
        ...
        $purchase_requisition_validate_data_save = $this->dispatch(new PurchaseRequisitionValidateJob($purchase_requisition_validate_data));
    }
}
