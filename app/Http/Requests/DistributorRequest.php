...
class DistributorRequest extends FormRequest
{
    ...
    public function rules()
    {
        switch ($this->method()) {
            ...
            {
                $rules = [
                'distributor_name' => 'required|unique:distributors,distributor_name,NULL,id,deleted_at,NULL|regex:'.config('regex.name'),
                'spoc_name' => 'required',
                'spoc_email' => 'required',
                'spoc_phone' => 'required',
                'gst_no' => 'required',
            ...
            case 'PATCH':
            {
                ...
                $rules = [
                'distributor_name' => 'required|unique:distributors,distributor_name,'.$this->segment(3).',id,deleted_at,NULL|regex:'.config('regex.name'),
                'spoc_name' => 'required',
                'spoc_email' => 'required',
                'spoc_phone' => 'required',
                'gst_no' => 'required',
    ...
    {
        $messages = [
            'distributor_name.required' => 'Distributor name should not be blank.',
            'distributor_name.regex' => 'Distributor name must be character.',
